...
<title><?php echo $title;?> Unversity college of science tumkur</title>
...
<section id="title-header">
  <div class="title">  
     <img class="logo" src="images/logo.png" width="35px" height="35px" style="border-radius:85%">Tumkur University <br>University College of Science
      <br><br>
      <p class="subtitle"> VIRTUAL CLASSROOM</p> 
  </div>
</section>  
<section id="navigation">
  <div id="mySidenav" class="sidenav">
    <a href="<?php echo web_root; ?>index.php?q=lesson" id="lesson">Lesson <i class="fa fa-book pull-right"></i></a> 
	...
	<a href="<?php echo web_root; ?>index.php?q=class" id="class">Class <i class="fa fa-video-camera pull-right"></i></a> 
    <a href="<?php echo web_root; ?>index.php?q=about" id="about">About Us <i class="fa fa-info-circle pull-right"></i></a>  
    <a href="<?php echo web_root; ?>index.php?q=chat" id="chat">Message <i class="fa fa-comments pull-right"></i></a> 
...
<footer  >
    <p align="center">&copy; UCS Tumkur</p>
</footer>
</section>
