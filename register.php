...
<section id="title-header">
  <div class="title">  
     <img class="logo" src="logo.png" width="40px" height="35px">Tumkur University <br>University College of Science
      <br>Tumkur
      <p class="subtitle"> UCST VIRTUAL CLASSROOM</p> 
  </div>
</section> 
...
?>
   <footer style="height: 100px;border-top:1px solid #ddd;padding: 5px;background-color: blue; color:#fff;">
              <p align="left">&copy; UCS Tumkur</p>
     </footer>
 </section>
