...
<title>UCST VIRTUAL CLASSROOM</title>
...
<div class="navbar-header">
  ...
  <a class="navbar-brand"  href="<?php echo web_root; ?>admin/index.php" >UCST VIRTUAL CLASSROOM </a>
</div>
...
<div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
            ...
            <!--     <li>
				...
				<li>
                     <a href="<?php echo web_root; ?>admin/modules/chat/index.php"><i class="fa fa-user fa-fw"></i> Message </a> 
                </li>
				<li>
                     <a href="<?php echo web_root; ?>admin/modules/class/index.php"><i class="fa fa-user fa-fw"></i> Online Class </a> 
                </li>
                 <li>
...
<section id="page-footer"> 
      <footer>  <p align="center">&copy; UCS Tumkur </p></footer>
</section>
<!-- Plugins -->
