...
<!-- 
        ...
        <div class="login100-more" style="background:darkblue;">
          <img src="adminMenu/images/logo.png" style="object-fit: contain;align:left;height:100px;width:100px;margin-left:30px;margin-top:310px;border-radius:15%">
		  <h1 style="align:left;height:100px;margin-left:190px;margin-top:-105px;color:white;font-size:35px">TUMKUR UNIVERSITY<br>University College of Science<br> Tumkur</h1>
      </div>
    </div>
  </div>
